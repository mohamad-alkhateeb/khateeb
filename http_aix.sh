#!/bin/ksh
HTTP="/usr/IBM/HTTPServer/conf"
APACHE_PREFIX="/usr/IBM/HTTPServer/"
APACHE_PREFIX2="/usr/IBM/HTTPServer"
...
groupownership=$( find $APACHE_PREFIX  \! -group system  -ls | wc -l | awk '{print $1}' )
if [[ $groupownership == 0 ]]
then
