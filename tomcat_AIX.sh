#!/bin/bash
CATALINA_HOME="/home/wasadmin/apache-tomcat-9.0.14"
echo " ENTER THE TOMCAT ADMIN USER NAME "
read tomcat_admin
echo " ENTER THE TOMCAT ADMIN GROUP NAME "
read tomcat_group
examples=$( ls -l $CATALINA_HOME/webapps/examples 2>/dev/null | wc -l | awk '{print $1}'  )
docs=$( ls -l $CATALINA_HOME/webapps/docs 2>/dev/null | wc -l | awk '{print $1}')
ROOT=$( ls -l $CATALINA_HOME/webapps/ROOT 2>/dev/null | wc -l | awk '{print $1}')
host_manager=$( ls -l $CATALINA_HOME/webapps/host-manager 2>/dev/null | wc -l | awk '{print $1}' )
manager=$( ls -l $CATALINA_HOME/webapps/manager 2>/dev/null | wc -l | awk '{print $1}' )
#app1="manager"
#app2="ald"
...
export num=`cat -n $CATALINA_HOME/conf/server.xml|grep "<!--" |grep '>'|awk '{print $1}' |awk '{print}' ORS='d;' |sed 's/.$//'` 
cat $CATALINA_HOME/conf/server.xml | sed -e $num >server.xml1
cat server.xml1 |sed '/<!--/,/-->/d' > $CATALINA_HOME/conf/server_back.xml 

chown $tomcat_admin:$tomcat_group    $CATALINA_HOME/conf/server_back.xml
xpoweredby=$( cat $CATALINA_HOME/conf/server_back.xml | grep  'xpoweredBy="true"'  | wc -l | awk '{print $1}' )
if [[ $xpoweredby == 0 ]]
then 
...
allow_trace=$( cat $CATALINA_HOME/conf/server_back.xml | allowTrace="true" |wc -l | awk '{print $1}')
if [[ $allow_trace == 0 ]]
then
...
server_existance=$( cat $CATALINA_HOME/conf/server_back.xml | grep "server=" | wc -l | awk '{print $1}' )
server=$( cat $CATALINA_HOME/conf/server_back.xml | grep -e server="Apache"| server="Apache-Coyote/1.1" | wc -l | awk '{print $1}' )
...
shutdown_value=$( cat $CATALINA_HOME/conf/server_back.xml | grep 'shutdown="SHUTDOWN"' | wc -l | awk '{print $1}'  ) 
if [[ $shutdown_value == 0 ]]
then
...
Server_port=$( cat $CATALINA_HOME/conf/server_back.xml | grep 'Server port="-1"' | wc -l | awk '{print $1}' )
if [[ $Server_port == 0 ]]
then
...
ownership=$( find  $CATALINA_HOME/. ! -name . -prune ! -user "$tomcat_admin" ! -group "$tomcat_group" | wc -l  | awk '{print $1}' )
#perm=$( find  $CATALINA_HOME -maxdepth 1   -perm /g+w,o+rwx | wc -l | awk '{print $1}'  )
perm=$(  find  $CATALINA_HOME \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l | awk '{print $1}'  ) 
...
ownership1=$(  find  $CATALINA_HOME/conf ! -user $tomcat_admin  ! -group $tomcat_group | wc -l | awk '{print $1}'  )
perm1=$( find  $CATALINA_HOME/conf  \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ownership2=$( find  $CATALINA_HOME/logs  ! -user $tomcat_admin ! -group $tomcat_group | wc -l  | awk '{print $1}' )
perm2=$(  find  $CATALINA_HOME/logs   \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ownership3=$( find  $CATALINA_HOME/temp ! -user $tomcat_admin  ! -group $tomcat_group | wc -l  | awk '{print $1}' )
perm3=$( find  $CATALINA_HOME/temp  \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ownership4=$( find  $CATALINA_HOME/bin  ! -user $tomcat_admin ! -group $tomcat_group  | wc -l  | awk '{print $1}' )
perm4=$( find  $CATALINA_HOME/bin   \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l | awk '{print $1}'  )
...
ownership5=$( find  $CATALINA_HOME/webapps  ! -user $tomcat_admin ! -group $tomcat_group  | wc -l | awk '{print $1}'  )
perm5=$( find  $CATALINA_HOME/webapps  \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ownership6=$( find $CATALINA_HOME/conf/catalina.properties  ! -user $tomcat_admin  ! -group $tomcat_group | wc -l  | awk '{print $1}' )
perm6=$( find $CATALINA_HOME/conf/catalina.properties  \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ownership7=$( find  $CATALINA_HOME/conf/catalina.policy ! -user $tomcat_admin ! -group $tomcat_group  | wc -l | awk '{print $1}'  )
perm7=$( find  $CATALINA_HOME/conf/catalina.policy  \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ownership8=$( find  $CATALINA_HOME/conf/context.xml ! -user $tomcat_admin ! -group $tomcat_group  | wc -l | awk '{print $1}'  )
perm8=$(  find  $CATALINA_HOME/conf/context.xml  \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ownership9=$(  find  $CATALINA_HOME/conf/logging.properties  ! -user $tomcat_admin  ! -group $tomcat_group | wc -l  | awk '{print $1}' )
perm9=$( find  $CATALINA_HOME/conf/logging.properties  \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ownership10=$( find  $CATALINA_HOME/conf/server.xml ! -user $tomcat_admin ! -group $tomcat_group  | wc -l | awk '{print $1}'  )
perm10=$( find  $CATALINA_HOME/conf/server.xml   \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ownership11=$( find  $CATALINA_HOME/conf/tomcat-users.xml ! -user $tomcat_admin ! -group $tomcat_group  | wc -l  | awk '{print $1}' )
perm11=$( find  $CATALINA_HOME/conf/tomcat-users.xml  \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ownership12=$( find  $CATALINA_HOME/conf/web.xml  ! -user $tomcat_admin ! -group $tomcat_group  | wc -l | awk '{print $1}'  )
perm12=$(  find  $CATALINA_HOME/conf/web.xml  \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
...
ls -l $CATALINA_HOME/conf/jaspic-providers.xml >/dev/null 2>&1
status_aspic=$?
ownership13=$( find  $CATALINA_HOME/conf/jaspic-providers.xml 2>/dev/null ! -user $tomcat_admin ! -group $tomcat_group  | wc -l  | awk '{print $1}'  )
perm13=$( find  $CATALINA_HOME/conf/jaspic-providers.xml 2>/dev/null   \( -perm -g+w -o -perm -o+r -o -perm -o+w -o -perm o+x \) | wc -l  | awk '{print $1}' )
if [[ $status_aspic == 2 ]]
then
...
REALM=$( cat  $CATALINA_HOME/conf/server_back.xml  | grep "Realm className" | grep -E  'UserDatabaseRealm| MemoryRealm | JDBCRealm | JAASRealm' | wc -l | awk '{print $1}'  )
if [[ $REALM == 0 ]]
then
...
LOCKOUT=$(  cat  $CATALINA_HOME/conf/server_back.xml | grep "LockOutRealm" | wc -l | awk '{print $1}'  ) 
if [[ $LOCKOUT == 0 ]]
then
...
CLIENT_AUTH=$(  cat  $CATALINA_HOME/conf/server_back.xml | grep 'clientAuth="true"' | wc -l | awk '{print $1}'  )
CERT_VIR=$( cat  $CATALINA_HOME/conf/server_back.xml | grep 'certificateVerification="required"' | wc -l  | awk '{print $1}' )
...
SSL_ENABLE=$(  cat  $CATALINA_HOME/conf/server_back.xml | grep 'SSLEnabled="true"' | wc -l  | awk '{print $1}' )
if [[ $SSL_ENABLE == 0 ]]
then
...
scheme=$( cat $CATALINA_HOME/conf/server_back.xml | grep 'scheme="https"' | wc -l  | awk '{print $1}' )
if [[ $scheme == 0 ]]
then
...
proto=$( cat $CATALINA_HOME/conf/server_back.xml | grep -e  'sslProtocol="TLSv1.2+TLSv1.3" | sslProtocol="TLSv1.2, TLSv1.3"' | wc -l | awk '{print $1}'  )

#sed -n '/Connector/{:start />/!{N;b start};/SSLEnabled="true"/p}' $CATALINA_HOME/conf/server_back.xml > $CATALINA_HOME/conf/ssl_connectors
SECURE_CONNECTORS=$( cat $CATALINA_HOME/conf/server.xml | grep 'secure="false"' | wc -l | awk '{print $1}'  )
...
proto=$( cat $CATALINA_HOME/conf/server.xml  | grep -e  'sslProtocol="TLSv1.2+TLSv1.3" | sslProtocol="TLSv1.2, TLSv1.3"' | wc -l | awk '{print $1}'  )
if [[ $proto == 0 ]]
then
...
classname=$( cat $CATALINA_HOME/webapps/$app1/META-INF/context.xml 2>/dev/null | grep 'className="org.apache.catalina.valves.AccessLogValve"' | wc -l  | awk '{print $1}' )
if [[ $classname == 0 ]] 
then
...
#fi
pattern=$(  cat $CATALINA_HOME/webapps/$app1/META-INF/context.xml 2>/dev/null | grep 'pattern="%h %t %H cookie:%{SESSIONID}c request:%{SESSIONID}r %m %U %s %q %r"' | wc -l  | awk '{print $1}' )
if [[ $pattern == 0 ]]
then
...
#fi
package_access_sun=$( cat $CATALINA_HOME/conf/catalina.properties | grep package.access | grep sun. | wc -l | awk '{print $1}'  )
package_access_apache==$( cat $CATALINA_HOME/conf/catalina.properties | grep package.access | grep "org.apache.catalina" | wc -l | awk '{print $1}'  )
package_access_coyote=$( cat $CATALINA_HOME/conf/catalina.properties | grep package.access | grep "org.apache.coyote." | wc -l  | awk '{print $1}' )
package_access_jasper=$( cat $CATALINA_HOME/conf/catalina.properties | grep package.access | grep "org.apache.jasper." | wc -l  | awk '{print $1}' )
package_access_tomcat=$(  cat $CATALINA_HOME/conf/catalina.properties | grep package.access | grep "org.apache.tomcat." | wc -l  | awk '{print $1}' )
...
auto_deploy=$( cat $CATALINA_HOME/conf/server_back.xml | grep 'autoDeploy="false"' | wc -l | awk '{print $1}'  )
if [[ $auto_deploy == 0 ]]
then
...
startup_deploy=$( cat $CATALINA_HOME/conf/server_back.xml | grep 'deployOnStartup="false"' | wc -l  | awk '{print $1}' )
if [[ $startup_deploy == 0 ]]
then
...
Class_Name=$( cat $CATALINA_HOME/conf/server_back.xml | grep "org.apache.catalina.valves.RemoteAddrValve" | wc -l | awk '{print $1}'  )
allow=$( cat $CATALINA_HOME/conf/server_back.xml | grep 'allow="127\.0\.0\.1"' | wc -l  | awk '{print $1}' )
if [[ $Class_Name == 0 ]]
then
...
SERVLET=$( cat $CATALINA_HOME/bin/catalina.sh | grep "Dorg.apache.catalina.STRICT_SERVLET_COMPLIANCE=true" | wc -l  | awk '{print $1}' )
if [[ $SERVLET == 0 ]]
then
...
FACADES=$( cat $CATALINA_HOME/bin/catalina.sh | grep "Dorg.apache.catalina.connector.RECYCLE_FACADES=true" | wc -l | awk '{print $1}'  )
if [[ $FACADES == 0 ]]
then
...
BACK_SLASH=$( cat $CATALINA_HOME/bin/catalina.sh | grep "Dorg.apache.catalina.connector.CoyoteAdapter.ALLOW_BACKSLASH=false" | wc -l  | awk '{print $1}' )
ENCODED_SLASH=$( cat $CATALINA_HOME/bin/catalina.sh | grep "Dorg.apache.tomcat.util.buf.UDecoder.ALLOW_ENCODED_SLASH=false" | wc -l  | awk '{print $1}' )
...
Tomcat_Connection_Timeout=$( cat $CATALINA_HOME/conf/server_back.xml | grep 'connectionTimeout="60000"' | wc -l | awk '{print $1}'  )
...
MAX_HTTP_HEADER=$( cat $CATALINA_HOME/conf/server_back.xml | grep 'maxHttpHeaderSize="8192"'  | wc -l  | awk '{print $1}' )
...
CONFIDENTIAL=$( cat $CATALINA_HOME/conf/web.xml | grep "<transport-guarantee>CONFIDENTIAL</transport-guarantee>" | wc -l  | awk '{print $1}' )
if [[ $CONFIDENTIAL == 0 ]]
then
...
allowLinking=$( find  $CATALINA_HOME -name context.xml | xargs grep 'allowLinking="true"' | wc -l | awk '{print $1}' )
if [[ $allowLinking == 0 ]]
then
...
privileged=$( find  $CATALINA_HOME -name context.xml | xargs grep 'privileged="true"' | wc -l | awk '{print $1}' )
if [[ $privileged == 0 ]]
then
...
enableLookups=$( cat $CATALINA_HOME/conf/server_back.xml | grep 'enableLookups="true"' | wc -l | awk '{print $1}' )
if [[ $enableLookups == 0 ]]
then
...
LISTENER=$( cat $CATALINA_HOME/conf/server_back.xml | grep '"org.apache.catalina.core.JreMemoryLeakPreventionListener"' | wc -l | awk '{print $1}'  )
if [[ $LISTENER == 0 ]]
then
...
metadata1=$( cat $CATALINA_HOME/webapps/$app1/WEB-INF/web.xml 2>/dev/null | grep 'metadata-complete="true"' | wc -l | awk '{print $1}'  )
effective1=$(  cat $CATALINA_HOME/webapps/$app1/META-INF/context.xml 2>/dev/null | grep 'logEffectiveWebXml="true"' | wc -l  | awk '{print $1}' )
